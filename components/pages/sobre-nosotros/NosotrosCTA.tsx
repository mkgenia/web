      ...
      <div className="relative z-10 max-w-container mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-10">
            30 minutos. Sin PowerPoints ni demos genéricas. Te contamos
            exactamente cómo funcionaría el sistema en tu agencia.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/plataforma"
              className="inline-flex items-center gap-2 px-7 py-3.5 border border-slate-300 dark:border-white/[0.18] hover:border-slate-400 text-slate-700 dark:text-white/80 hover:text-slate-900 dark:hover:text-white rounded-full text-sm font-medium transition-all duration-200"
            >
              Ver la plataforma
            </Link>
          </div>
